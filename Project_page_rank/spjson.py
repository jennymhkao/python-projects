...
'''This program looks at the highest number of inbound links'''
...
# Read through all the rows and pull out page rank
...
for row in nodes :
    ...
    # print row
    rank = row[2]
    # normalize rank to be thickness of lines and size of balls
